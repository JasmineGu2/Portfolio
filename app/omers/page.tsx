...
export default function OMERSCaseStudy() {
            ...
            <div className="relative z-10 px-8 md:px-12 py-12 md:py-16">
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors">OMERS • 2023</div>
                ...
                <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-8 transition-colors" style={{ fontFamily: "Inter" }}>
                  Redesigned workflows and automated enterprise processes by 60-70%. Conducted user interviews to understand needs and translated technical requirements into business solutions.
                </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                  <div>
                    ...
                    <div className="text-base font-medium text-[#2A2A2A] dark:text-white transition-colors" style={{ fontFamily: "Inter" }}>Solutions Architect</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-base font-medium text-[#2A2A2A] dark:text-white transition-colors" style={{ fontFamily: "Inter" }}>Enterprise Solutions</div>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2 transition-colors">SKILLS</div>
                    <div className="text-base font-medium text-[#2A2A2A] dark:text-white transition-colors" style={{ fontFamily: "Inter" }}>Solutions Architecture, Automation, UX Research</div>
                  </div>
                </div>
