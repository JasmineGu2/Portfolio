              ...
              <div className="mb-16">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 transition-colors">
                  <div>
                    ...
                    <div className="text-sm font-medium text-[#2A2A2A] dark:text-white transition-colors font-['Inter',sans-serif]">Solutions Architect</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-[#2A2A2A] dark:text-white transition-colors font-['Inter',sans-serif]">Solutions Architecture, Automation, UX Research</div>
                  </div>
                </div>
              </div>
