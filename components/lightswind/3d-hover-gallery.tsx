          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isFocused
                  ? "ring-2 ring-[var(--pf-ink)] ring-offset-2 dark:ring-offset-zinc-950 scale-[1.01] border-[var(--pf-ink)]/50"
                  : "",
                  ...
                  {isActive && (
                    <div className="flex flex-col items-start w-full">
                      ...
                      <motion.span
                        ...
                        className="text-[9px] font-black tracking-widest uppercase text-[var(--pf-ink)] mb-1"
                      >
                        {item.category}
                      </motion.span>
                      ...
                      <motion.div
                        ...
                        className="flex items-center gap-1 text-[9px] font-bold tracking-widest uppercase text-zinc-100 hover:text-white group/btn"
                      >
                        <span>Explore</span>
